    ...
    : QDialog(parent)
{
    ...
    connect(m_pNewFileWidget->typeIconView, &QListWidget::itemSelectionChanged,
            this, &NewFileDlg::fileTypeChanged);
    connect(m_pNewFileWidget->typeIconView, &QListWidget::doubleClicked,
            this, &NewFileDlg::accept);
